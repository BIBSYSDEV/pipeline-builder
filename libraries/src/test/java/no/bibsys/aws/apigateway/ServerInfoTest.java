...
public class ServerInfoTest {
    ...
    public void completeServerUrl_HttpsserverUrlAndStage_workingSeverUrl() {
        ...
        assertThat(serverInfo.serverAddress(),
            is(equalTo("xxxxxxxx.execute-api.eu-west-1.amazonaws.com")));
    }

    @Test
    public void completeServerUrl_HttpserverUrlAndStage_workingSeverUrl() {
        ServerInfo serverInfo = new ServerInfo(
            "http://xxxxxxxx.execute-api.eu-west-1.amazonaws.com/{basePath}", "final");
        assertThat(serverInfo.serverAddress(),
            is(equalTo("xxxxxxxx.execute-api.eu-west-1.amazonaws.com")));
    }
