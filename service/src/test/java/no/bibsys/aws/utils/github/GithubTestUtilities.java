...
public class GithubTestUtilities {
    ...
    //package-private
    static final BasicStatusLine STATUS_LINE_UNAUTHORIZED = new BasicStatusLine(new ProtocolVersion(PROTOCOL,
    ...
    //package-private
    static final BasicStatusLine STATUS_LINE_NOT_FOUND = new BasicStatusLine(new ProtocolVersion(PROTOCOL,
