...
public class Route53UpdaterTest {
    ...
    public Route53UpdaterTest() {
        ...
        route53Updater = new Route53Updater(staticUrlINfo, gitInfo, Stage.TEST,
            "apiGatewarRestApiId", apiGateway);
    ...
    public void updateRecorsrSetsRequest_ServerInfo_changeBatchWithOneChange()
        ...
        ChangeResourceRecordSetsRequest request =
            (ChangeResourceRecordSetsRequest) method
    ...
    public void updateRoute53() throws IOException {
        ...
        Optional<ChangeResourceRecordSetsRequest> request = updater
            .createUpdateRequest(certificateArn);

        Optional<ChangeResourceRecordSetsResult> result = request.map(updater::executeRequest);
