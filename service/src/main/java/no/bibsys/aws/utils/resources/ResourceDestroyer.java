 ...
 * deletes the disconnected resources. It is usually called thought a handler of a Lambda function (see {@link
 * no.bibsys.aws.lambda.deploy.handlers.DestroyHandler}).
...
public class ResourceDestroyer extends ResourceManager {
    ...
    public ResourceDestroyer(String stackName, StaticUrlInfo staticUrlInfo, SwaggerHubInfo swaggerHubInfo, Stage stage,
        ...
        swaggerHubUpdater = initSwaggerHubUpdater(stackName, swaggerHubInfo, stage, gitInfo, apiGateway,
            apiGatewayRestApi);
    ...
    public void destroy() throws IOException, URISyntaxException {
        ...
        Optional<ChangeResourceRecordSetsRequest> request = this.route53Updater.createDeleteRequest();
